generate_journal_state_plot <- function(df, tiff = FALSE){
  ...
  #   theme_classic() +
  #   ggtitle("") +
  #   harrypotter::scale_fill_hp_d("Ravenclaw", limits = c("men", "women")) +
  #   theme(strip.background =element_rect(fill="gray70"),
  #         strip.text = element_text(face = "bold", size = 14),
  ...
  ggsave("figs/JOURNAL_state_plot.png")
  if(tiff){
    ggsave("figs/JOURNAL_state_plot.tiff")
  }
  
  return("figs/JOURNAL_state_plot.png")
}