...
data_folders <- list.dirs("data/sars_mers_downloads")[str_detect(list.dirs("data/sars_mers_downloads/"), "downloaded")]
...
# write_csv(final_df, glue("data/{dir_name}/sars_mers_data.csv"))
...
write_csv(final_df_v2_gm, glue("data/{dir_name}/sars_mers_data.csv"))
